      ...
      <Container>
        ...
        <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
          <div className="flex gap-x-6">
            <a
              href="https://github.com/stencila"
              target="_blank"
              className="group"
            ...
            <a
              href="https://discord.gg/XMNrcWqykZ"
              target="_blank"
              className="group"
              aria-label="Stencila on Discord"
            >
              <svg
                aria-hidden="true"
                className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700"
            ...
            <a
              ...
              target="_blank"
              className="group"
              aria-label="Stencila on YouTube"
            >
              <svg
                aria-hidden="true"
                className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700"
          ...
          <p className="mt-6 text-sm text-slate-500 sm:mt-0">
            Made in{' '}
            <a href="https://www.kaikoura.co.nz/" target="_blank">
              🐳 Kaikōura
            </a>
            ,{' '}
            <a href="https://www.mtl.org/en" target="_blank">
              🍁 Montréal
            </a>{' '}
            and{' '}
            <a href="https://www.lakewanaka.co.nz/" target="_blank">
              🏔️ Wānaka
            </a>
            .
          </p>
          <p className="mt-6 text-sm text-slate-500 sm:mt-0">
            &copy; {new Date().getFullYear()} Stencila
          </p>
        </div>
      </Container>
    </footer>
